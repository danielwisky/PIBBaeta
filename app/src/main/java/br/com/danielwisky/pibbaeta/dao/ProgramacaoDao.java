...
public class ProgramacaoDao extends AbstractDao<Programacao, Long> {
  ...
  public static class Properties {
    ...
    public final static Property TipoProgramacao = new Property(2, String.class, "tipoProgramacao", false, "TIPO_PROGRAMACAO");
  ...
  public static void createTable(Database db, boolean ifNotExists) {
    ...
    db.execSQL("CREATE TABLE " + constraint + "\"PROGRAMACAO\" (" + //
        ...
        "\"TIPO_PROGRAMACAO\" TEXT NOT NULL ," + // 2: tipoProgramacao
        "\"DESCRICAO\" TEXT NOT NULL ," + // 3: descricao
  ...
  protected final void bindValues(DatabaseStatement stmt, Programacao entity) {
    ...
    stmt.bindString(3, entity.getTipoProgramacao());
    stmt.bindString(4, entity.getDescricao());
  ...
  public Programacao readEntity(Cursor cursor, int offset) {
    Programacao entity = new Programacao( //
        ...
        cursor.getString(offset + 2), // tipoProgramacao
        cursor.getString(offset + 3), // descricao
  ...
  public void readEntity(Cursor cursor, Programacao entity, int offset) {
    ...
    entity.setTipoProgramacao(cursor.getString(offset + 2));
    entity.setDescricao(cursor.getString(offset + 3));
